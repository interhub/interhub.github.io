...
},{"buffer":"../../../../.config/yarn/global/node_modules/buffer/index.js"}],"../../../../.config/yarn/global/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../../.config/yarn/global/node_modules/process/browser.js"}],"src/utils.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getSumNumbers = exports.stringToNumber = exports.getDiffItemsKoef = exports.getDiffPercent = void 0;

var getDiffPercent = function getDiffPercent(from, to) {
  return (to - from) / from * 100;
};

exports.getDiffPercent = getDiffPercent;

var getDiffItemsKoef = function getDiffItemsKoef(item1, item2) {
...
exports.getDiffItemsKoef = getDiffItemsKoef;

var stringToNumber = function stringToNumber(str) {
  return Number(str.slice(0, -4).replace(/\./g, '')) / 1000;
};

exports.stringToNumber = stringToNumber;

var getSumNumbers = function getSumNumbers() {
...
exports.getSumNumbers = getSumNumbers;
...
exports.TOP = exports.SAME_PERIOD = void 0;
exports.SAME_PERIOD = 7; //of DAYS

exports.TOP = 10; //first of more same count show
...
},{}],"src/getHistoryAsync.ts":[function(require,module,exports) {
"use strict";
...
var getHistoryAsync = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _dataServer$Data;

    var url, _yield$axios_1$defaul, dataServer, arr;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = 'https://min-api.cryptocompare.com/data/v2/histoday?fsym=BTC&tsym=USD&limit=2000&toTs=-1&api_key=YOURKEYHERE';
            _context.next = 3;
            return axios_1.default.get(url);

          case 3:
            _yield$axios_1$defaul = _context.sent;
            dataServer = _yield$axios_1$defaul.data;
            arr = (dataServer === null || dataServer === void 0 ? void 0 : (_dataServer$Data = dataServer.Data) === null || _dataServer$Data === void 0 ? void 0 : _dataServer$Data.Data) || [];
            return _context.abrupt("return", arr.map(function (_ref2) {
              var time = _ref2.time,
                  high = _ref2.high,
                  low = _ref2.low,
                  open = _ref2.open,
              ...
              return {
                TICKER: '',
                DATE: (0, moment_1.default)(time * 1000).format('DD/MM/YY'),
                LOW: low,
                HIGH: high,
                OPEN: open,
                CLOSE: close,
                ...
                VOL: 0,
                TIME: time,
                TOP_SHADOW_PERCENT: (0, utils_1.getDiffPercent)(Math.max(open, close), high),
                LOW_SHADOW_PERCENT: (0, utils_1.getDiffPercent)(low, Math.min(open, close)),
                CHANGE_PERCENT_REAL: (0, utils_1.getDiffPercent)(open, close)
              };
            }));
  ...
  return function getHistoryAsync() {
    return _ref.apply(this, arguments);
  };
}();

exports.default = getHistoryAsync;
},{"axios":"node_modules/axios/index.js","moment":"node_modules/moment/moment.js","./utils":"src/utils.ts"}],"src/getPredicts.ts":[function(require,module,exports) {
"use strict";
...
var getHistoryAsync_1 = __importDefault(require("./getHistoryAsync"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, getHistoryAsync_1.default)();
          ...
          case 2:
            ...
            getCheckedPeriods = function getCheckedPeriods() {
              ...
              history.map(function (obj, i, arr) {
                try {
                  ...
                  var diffSumKoef = (0, utils_1.getSumNumbers).apply(void 0, _toConsumableArray(diffKoefsPeriod));
                  var dates = period.map(function (_ref2) {
                    var DATE = _ref2.DATE;
                    return DATE;
                  }).join('   ');
            ...
            CHECKED_PERIODS = getCheckedPeriods();
            SORTED_CHECKED_PERIODS = (0, lodash_1.sortBy)(CHECKED_PERIODS, 'diffSumKoef');
            MAX_SAMES_PERIODS = SORTED_CHECKED_PERIODS.slice(0, config_1.TOP);
            return _context.abrupt("return", MAX_SAMES_PERIODS.map(function (_ref3) {
              var diffSumKoef = _ref3.diffSumKoef,
                  dates = _ref3.dates,
                  index = _ref3.index;
              var targetItem = CHECKED_PERIODS[index];
              if (!targetItem) return null;
              var nextChangePercent = targetItem.nextDayChange;
              return {
                dates: dates,
                diffSumKoef: diffSumKoef,
                nextChangePercent: nextChangePercent
              };
            }).filter(Boolean));
...
exports.default = getPredicts;
},{"./utils":"src/utils.ts","lodash":"node_modules/lodash/lodash.js","./config":"src/config.ts","./getHistoryAsync":"src/getHistoryAsync.ts","moment":"node_modules/moment/moment.js"}],"node_modules/gridjs/dist/gridjs.module.js":[function(require,module,exports) {
"use strict";
...
exports.PluginBaseComponent = ct;
exports.BaseActions = st;
exports.BaseStore = it;
...
},{}],"src/printChart.ts":[function(require,module,exports) {
"use strict";
...
var gridjs_1 = require("gridjs");

var changeCol = {
  name: 'Изменение цены  историческое (%)',
  formatter: function formatter(cell) {
    return (0, gridjs_1.h)('b', {
      style: {
...
var printChart = function printChart(predicts) {
  var sortedPredicts = (0, lodash_1.sortBy)(_toConsumableArray(predicts), function (p) {
    return p.diffSumKoef;
  });
  var percents = sortedPredicts.map(function (_ref, index) {
    var nextChangePercent = _ref.nextChangePercent,
        diffSumKoef = _ref.diffSumKoef,
        dates = _ref.dates;
    return [index + 1, nextChangePercent, diffSumKoef, dates];
  });
...
exports.default = printChart;
},{"lodash":"node_modules/lodash/lodash.js","browser-or-node":"node_modules/browser-or-node/lib/index.js","gridjs":"node_modules/gridjs/dist/gridjs.module.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var getPredicts_1 = __importDefault(require("./src/getPredicts"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            (0, printChart_1.default)(PREDICTES);

            testPeriods = function testPeriods(predicts) {
              var _ref2, _ref3;
