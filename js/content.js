...
window.SITE_CONTENT = {
  ...
  ru: {
    ...
    hero: {
      ...
      headlineAfter: " бизнес и отвечаю за инженерию, которая его держит.",
      subtext:
    ...
    cases: {
      ...
      items: [
        ...
        { title: "Bismap", role: "Backend и мобильное (один разработчик)", oneline: "B2B-приложение для тендеров: регистрация бизнеса, заявки и весь backend, передано заказчику в самостоятельное управление.", tags: ["Nest.js", "React Native", "MongoDB", "B2B", "Backend"] },
        { title: "Stayfit", role: "Senior fullstack (React Native, Node.js)", oneline: "Корпоративное wellbeing-приложение: спорт-челленджи, онлайн-консультации, обучающий контент и соревнования команд.", tags: ["React Native", "Node.js", "GraphQL", "MongoDB", "Tech Lead"] },
  ...
  en: {
    ...
    cases: {
      ...
      items: [
        ...
        { title: "Bismap", role: "Backend and mobile (solo developer)", oneline: "A B2B tenders app: business registration, applications, and the full backend, then handed to the client to run.", tags: ["Nest.js", "React Native", "MongoDB", "B2B", "Backend"] },
        { title: "Stayfit", role: "Senior fullstack (React Native, Node.js)", oneline: "A corporate wellbeing app: sport challenges, online consultations, training content, and team competition.", tags: ["React Native", "Node.js", "GraphQL", "MongoDB", "Tech Lead"] },
  ...
  zh: {
    ...
    cases: {
      ...
      items: [
        ...
        { title: "Bismap", role: "后端与移动端（独立开发）", oneline: "一款 B2B 招投标应用：企业注册、投标申请以及完整后端，随后交付给客户自主运营。", tags: ["Nest.js", "React Native", "MongoDB", "B2B", "Backend"] },
        { title: "Stayfit", role: "高级全栈 (React Native, Node.js)", oneline: "一款企业健康应用：运动挑战、在线咨询、训练内容与团队竞赛。", tags: ["React Native", "Node.js", "GraphQL", "MongoDB", "Tech Lead"] },
